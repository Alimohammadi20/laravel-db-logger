...
(function () {
    ...
    const flatpickrDateToday = document.querySelectorAll('.flatpickr-date-today')
    //   ,
    ...
    const flatpickrRange = document.querySelectorAll('.flatpickr-range');
    ...
    // Date
    if (flatpickrDateToday) {
        flatpickrDateToday.flatpickr({
            monthSelectorType: 'dropdown',
            locale: 'fa',
            altInput: true,
            altFormat: 'Y/m/d',
